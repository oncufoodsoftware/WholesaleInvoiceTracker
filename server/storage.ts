...
export interface IStorage {
  ...
  getDateRangeSummary(branchId: number, startDate: Date, endDate: Date): Promise<DailyFinancialSummary>;
...
export class DatabaseStorage implements IStorage {
  ...
  async getDateRangeSummary(branchId: number, startDate: Date, endDate: Date): Promise<DailyFinancialSummary> {
    return this.getSummarizedTransactionsByDateRange(branchId, startDate, endDate);
  }
